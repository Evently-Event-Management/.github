...
- **[infra-api-gateway](https://github.com/Evently-Event-Management/infra-api-gateway)**: API Gateway service (Not used in deployment, replaces by k8s traefik ingress)
